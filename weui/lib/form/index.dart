...
class WeForm extends StatefulWidget {
  ...
  static WeFormState of(BuildContext context) {
    final WeFormScope scope = context.dependOnInheritedWidgetOfExactType(aspect: WeFormScope);
    return scope?.state;
  }
...
class WeFormScope extends InheritedWidget {
  ...
  static WeFormScope of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType(aspect: WeFormScope);
  }
